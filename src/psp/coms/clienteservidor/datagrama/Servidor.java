...
public class Servidor {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Soy el serivdor y empiezo a escuchar por " + PUERTO);
        ...
        try (DatagramSocket socketUDP = new DatagramSocket(PUERTO)){
            ...
            while (true){
                ...
                System.out.println("Datagrama recibido del host: " + peticion.getAddress() + " desde el puerto: " + peticion.getPort());
